    ...
    <aside className="w-60 flex-shrink-0 bg-slate-900 border-r border-slate-800 flex flex-col">
      ...
      <div className="px-5 py-5 border-b border-slate-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-white font-bold text-sm leading-tight">Tinrate</p>
            <p className="text-slate-500 text-xs leading-tight">Admin Console</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-3 py-4 border-t border-slate-800">
        <button
          onClick={onLogout}
          className="flex items-center gap-3 w-full px-3 py-2 rounded-lg text-sm font-medium text-slate-400 hover:text-white hover:bg-slate-800 transition-all"
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>

...
- [ ] **Phase 45: Security and Infrastructure Hardening** - Upgrade admin auth to bcrypt+JWT, add rate limiting, enable SQLite WAL mode, fix t-SNE heatmap
...
| 45. Security + Infrastructure | v4.0 | 0/2 | Not started | - |

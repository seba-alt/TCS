...
- FOUND: frontend/src/components/marketplace/ExpertCard.tsx
- FOUND: frontend/src/components/marketplace/ExpertGrid.tsx
- FOUND: .planning/phases/21-documentation-cleanup/21-02-SUMMARY.md
- FOUND commit: a6f64c0 (Task 1 — remove dead triggerSearch comment)
- FOUND commit: 6ed398f (Task 2 — remove dead index prop)

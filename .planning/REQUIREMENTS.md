...
- [x] **TAGS-05**: When an admin adds a new expert via the admin dashboard, the system automatically generates domain tags and computes a findability score for that expert immediately (no manual batch run required)
